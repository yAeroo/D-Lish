...
<section className='mt-4'>
        <div className="flex flex-col sm:w-[97%] w-[90%] lg:flex-row sm:p-5 ">
         ...
         <div className="grid md:flex h-56 p-5 flex-grow  bg-secu place-items-center  md:w-11 lg:w-11 xl:w-11 ">
        ...
        <div className="flex flex-col sm:w-[97%] w-[90%] lg:flex-row sm:p-5  h-32 md:h-56 ">
          <div className="flex flex-row flex-grow gap-3 justify-center bg-secu md:bg-transparent place-items-center md:h-42  h-40   "> {/*  estaba en grid*/}

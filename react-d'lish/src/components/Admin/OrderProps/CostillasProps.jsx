...
import CostillasContent from '../OrderContent/CostillasContent';

function CostillasProps() {
  return (
<div className="flex items-center w-[95%] justify-center">
        <div className="container">
          ...
          <tbody className="flex-1 sm:flex-none text-[#414141]">
            ...
            <CostillasContent  nameuser="José Costillas" platillo="Desayuno" content1="Arroz" content2="Chimol" />

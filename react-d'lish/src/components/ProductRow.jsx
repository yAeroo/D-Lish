...
function ProductRow(props) {
      return (
                ...
                <tr className="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
					...
					<td className="border-grey-light border p-3  hover:font-medium cursor-pointer ">
                        <div className='flex sm:justify-center gap-3'>
						<AiFillDelete className='text-2xl sm:text-2xl text-red-400 hover:text-red-600'></AiFillDelete>
                        <RiEdit2Fill className='text-2xl sm:text-2xl text-terc hover:text-[#6dcfa1]'></RiEdit2Fill>
                        </div>
                    </td>

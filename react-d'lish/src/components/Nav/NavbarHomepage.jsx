...
const NavbarHomepage = () => {
  ...
  return (
    <section className='py-4 md:px-24 px-4'>
      ...
      <nav className='flex justify-between rounded-2xl bg-green-600 px-6 py-5 list-none '>
        {/* Link a Homepage */}
        <Link to='/'>
      ...
      {showMenu && (
        <div className="md:hidden flex flex-col items-center justify-center gap-5 py-3 my-1 text-white list-none bg-green-500 rounded-t-lg rounded-2xl animate-fade-down animate-duration-300 animate-ease-in-out ">
          <NavLinks />
        </div>
      )}
    </section>

...
export default function FoodCardSearchMobile(props) {
    const { photo, name, cafetin, precio, categoria } = props;
  return (
    <div className="flex items-center justify-center mx-0 h-[7rem] w-100 hover:bg-neutral rounded-lg px-0 mb-1">
            <div className="flex items-center justify-start space-x-0 md:space-x-4 mt-0 ml-4 w-[100%] md:w-[100%]">

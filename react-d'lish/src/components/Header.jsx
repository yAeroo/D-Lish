...
import HeroImg from '../assets/dlishMockup2.png';
import ButtonFill from './ButtonFill';
import ButtonOutline from './ButtonOutline';

const Header = () => {
  return ( 
    <section className='bg-gradient-to-r from-indigo-950 to-violet-900 bg-Hero bg-cover bg-center h-screen py-4 md:px-24 px-4'>
        <Navbar />
        <div className='flex md:flex-row flex-col gap-5 pt-20'>
            <div className='flex-1'>
                ...
                leading-snug'>Ordena tu comida de manera rapida y sencilla</h1>

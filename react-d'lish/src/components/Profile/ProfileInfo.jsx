  ...
  return (
    <>
      <div id="profile-pic" className="w-full flex justify-center">
        <img src={`/assets/pfp/${user?.profile_pic}`} className="-mt-28 w-48 h-48 lg:w-56 lg:h-56 rounded-full border-8 border-solid border-[#202949] transition-all" alt="profile-pic" />
      </div>

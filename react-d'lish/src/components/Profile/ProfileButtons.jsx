    ...
    return (
        <>
            <div id="pf-bttns">
                ...
                <div id="funds-show" className="fu-custom animate-fade-right absolute top-9 left-[5%] md:left-[3%] lg:left-[10%]">
                ...
                <div id="edit-bttn" className="fu-custom animate-fade-left absolute top-9 right-[5%] md:right-[3%] lg:right-[10%]">

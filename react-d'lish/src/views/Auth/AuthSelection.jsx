        ...
        <>
            <div id="authSelector" className="min-h-[80vh] mb-4 px-8 sm:px-20 grid transition-all">
                <div id="authSelectCont" className="w-full flex flex-col place-self-center">
                    ...
                    <div className="flex-col md:flex-row w-full flex justify-center mt-5 text-white">
                        <div id="LoginCard">
                            <div className="card lg:card-side h-full !bg-[#2c2c2c] shadow-xl min-w-[300px] max-w-[300px] lg:min-w-[425px] lg:max-w-[425px]">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="card-actions justify-center">
                                        <button className="bg-secondary hover:bg-base-100 transition-all rounded-full p-2 text-white mt-2 px-8 font-bold">Ingresar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="SignUpCard">
                            <div className="card lg:card-side h-full !bg-[#2c2c2c] shadow-xl min-w-[300px] max-w-[300px] lg:min-w-[425px] lg:max-w-[425px]">
                                <div className="card-body">
                                    ...
                                    <div className="card-actions justify-center">
                                        <button className="bg-primary hover:bg-base-100 transition-all rounded-full p-2 text-white mt-2 px-8 font-bold">Ingresar</button>
                                    </div>
                                </div>

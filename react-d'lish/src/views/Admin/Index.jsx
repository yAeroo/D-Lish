...
import Userphoto from "/src/assets/index/user.png";
...
export default function Admin() {
  ...
  const usuarios = [{ name: "Óscar Elías" }, { name: "Eleazar Amaya" }];
            ...
            <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between ">
              <div className="mr-6">
                <h1 className="text-4xl font-semibold mb-2 text-primary">
                  {t("logs.cafeteria")} {cafeteria?.name}
                </h1>
                <h2 className="text-black ml-0.5">
              ...
              <div className="flex flex-wrap items-start justify-end -mb-3 mt-6">
                <button className="inline-flex px-5 py-3 text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100 border border-purple-600 rounded-md mb-3">
                  ...
                  <Link to="/admin/profile">{t("admin.edit-cafeteria")}</Link>
                </button>
              </div>
            </div>
            ...
            <section className="grid md:grid-cols-2 grid-cols-1  gap-6 ">
              ...
              <div className="row-span-3 bg-neutral text-yellow-50 shadow rounded-lg">
                <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                  <span>{t("admin.frecuent-users")}</span>
                </div>
                {/* Tablero de usuarios */}
              ...
              <div className="flex flex-col row-span-3 bg-neutral shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b text-yellow-50 border-gray-100">
                  {t("admin.most-sold-title")}
                </div>

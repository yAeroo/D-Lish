...
const Page404 = () => {
  ...
  return (
    <div className=' text-center flex h-screen w-full justify-center items-center flex-col'>
        ...
        <div className='p-3 sm:text-2xl'>
            <img className="animate-fade-up" src="..\src\assets\logo\404\PNG-RGB-404-2.png" alt="Error 404" />
      ...
      <Link to="#" className=' animate-fade-up btn btn-primary ' onClick={() => window.history.back()}>

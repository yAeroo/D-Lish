...
export default function Profile() {
    return (
        <>
            <section id="profile" className="min-h-screen bg-[url('../../public/img/banner.jpg')] bg-cover flex items-end justify-center pt-40">
                <article id="profile-info" className="bg-white h-[80vh] sm:w-10/12 w-full sm:rounded-t-3xl p-5 shadow-black shadow-lg transition-all">
                    <div id="profile-pic" className="w-full flex justify-center">
                        <img src="../../public/img/example-pfp.jpg" className="-mt-28 w-52 lg:w-60 rounded-full border-8 border-solid border-white transition-all"/>
                    </div>
